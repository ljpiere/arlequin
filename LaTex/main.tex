...
\newcommand{\codebreak}[1]{%
  \texttt{\begingroup\def\_\allowbreak\_\relax #1\endgroup}%
}
...
% ESTA línea es la que define el entorno groupplot:
...
\usepackage{array}
\usepackage{makecell}
\setlength{\tabcolsep}{3pt}  % reduce el espacio horizontal interno
\renewcommand{\arraystretch}{0.9}  % reduce espacio vertical
...
%%%%%%%%%%%%%%%%%%
\clearpage
\input{src/00-ficha_resumen}

%%%%%%%%%%%%%%%%%%
% AGRADECIMIENTOS
%%%%%%%%%%%%%%%%%%
\input{src/00-agradecimientos}
...
%%%%%%%%%%%%%%%%%%%%%%
\chapter{Evaluación}
\input{src/4-evaluacion}

%%%%%%%%%%%%%%%%%%%%%%
% CONCLUSIONES
%%%%%%%%%%%%%%%%%%%%%%
\chapter{Conclusiones}
\input{src/5-conclusiones.tex}

%%%%%%%%%%%%%%%%%%%%%%
% ANEXOS
%%%%%%%%%%%%%%%%%%%%%%
%\appendix
%\input{src/anexo-contexto.tex}
